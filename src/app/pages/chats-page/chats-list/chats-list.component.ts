...
export class ChatsListComponent {
  ...
  filterChatsControl = new FormControl('');
    ...
    public chats = toSignal(timer(0, TIMEOUT)
      .pipe(
        switchMap(() => {
  ...
  private readonly filterChatsControlValue = toSignal(this.filterChatsControl.valueChanges, {initialValue: this.filterChatsControl.value})
